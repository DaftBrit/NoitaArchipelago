...
dofile_once("data/archipelago/scripts/patches/patch_shader.lua")
dofile_once("data/archipelago/scripts/patches/patch_emissives.lua")
dofile_once("data/archipelago/scripts/patches/patch_knockback.lua")
dofile_once("data/archipelago/scripts/patches/patch_perk_reroll.lua")
