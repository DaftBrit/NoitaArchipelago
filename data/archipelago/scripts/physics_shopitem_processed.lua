...
function item_pickup(entity_item, entity_who_picked, name)
	...
	local item_file = get_variable_storage_component(entity_item, "item_file")
	local inventory = find_inventory_entity(entity_who_picked)
	local item = EntityLoad(item_file)
